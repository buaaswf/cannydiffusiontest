 im = imread('E:\geo\testbmps\2o.bmp');
 im=rgb2gray(im);
%  imshow(s);
  num_iter = 15;
  delta_t = 1/7;
...
figure, subplot 121, imshow(im,[]), subplot 122, imshow(diff_im,[]);
 diff_im2=uint8(diff_im);
imwrite(diff_im2,'E:\geo\testbmps\2o_anisodff.bmp');

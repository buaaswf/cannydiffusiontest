...
Im=medfilt2(I1,[5 5]);
Histeqmed=histeq(Im);
Histeqguass=histeq(Ig);
HisteqI1=histeq(I1);
%# Display
% imshow(Ig)
imwrite(I1,'E:\geo\testbmps\t0oitr20bgconditiond1.bmp');
imwrite(Ig,'E:\geo\testbmps\t0oiter20eguass.bmp');
imwrite(Im,'E:\geo\testbmps\t0oiter20emedfilt.bmp');
imwrite(Histeqmed,'E:\geo\testbmps\t0oiter20Histeqmed.bmp');
imwrite(Histeqguass,'E:\geo\testbmps\t0oiter20Histeqguass.bmp');
imwrite(HisteqI1,'E:\geo\testbmps\t0oiter20HisteqI1.bmp');